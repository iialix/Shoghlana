document.addEventListener("DOMContentLoaded", function () {
    ...
    function displayJobs(jobs){
      jobs.forEach((job) => {
        ...
        jobDiv.setAttribute(
          "data-url",
          `applied_job_details.html?title=${encodeURIComponent(job.title)}&company=${encodeURIComponent(job.company)}&id=${job.id}&salary=${job.salary}&status=${job.status}&experience=${job.experience}&description=${encodedDescription}`
        );
